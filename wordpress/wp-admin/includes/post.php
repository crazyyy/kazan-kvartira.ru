...
function get_sample_permalink_html( $id, $new_title = null, $new_slug = null ) {
	...
	if ( false === strpos($permalink, '%postname%') && false === strpos($permalink, '%pagename%') ) {
		$return = '<strong>' . __('Permalink:') . "</strong>\n" . '<span id="sample-permalink">' . esc_html( $permalink ) . "</span>\n";
		...
		if ( isset($view_post) )
			$return .= "<span id='view-post-btn'><a href='" . esc_url( $permalink ) . "' class='button' target='_blank'>$view_post</a></span>\n";
	...
	if ( isset($view_post) )
		$return .= "<span id='view-post-btn'><a href='" . esc_url( $view_link ) . "' class='button' target='_blank'>$view_post</a></span>\n";
